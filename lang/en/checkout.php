...
return [
    ...
    'handling_fee_note' => 'A :amount handling fee applies to all orders.',
    'shipping_free' => 'FREE',
    ...
    'arrives_on' => 'Arrives :date',
    'arrives_between' => 'Arrives :from – :to',
    'dispatches_today' => 'dispatches today',
    'ships_from' => 'Ships from :country',
    ...
    'paysera_option_note' => 'Pay securely via Paysera · Card · Bank link',
    'secure_paysera_checkout' => 'Secure Paysera checkout',
    'secure_paysera_checkout_note' => 'You will be redirected to Paysera to complete payment securely. This step stores only your payment preference.',
