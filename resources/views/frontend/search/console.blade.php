    ...
    <div class="relative max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 pt-10 pb-24">
                ...
                <div class="relative border border-ink bg-paper bp-register">
                    ...
                    <div class="p-5 space-y-3">
                        <div class="bp-leader pt-0.5">
                            ...
                            <dd class="font-mono text-sm font-bold text-ink">{{ \App\Models\Manufacturer::where('is_active', true)->count() }}+</dd>
                        </div>
                        <div class="bp-leader">
                            <dt class="text-sm text-ink-muted">{{ __('search.console_status_skus') }}</dt>
                            <span class="bp-leader-dots"></span>
                            <dd class="font-mono text-sm font-bold text-ink">{{ number_format(\App\Models\Product::where('is_active', true)->count()) }}</dd>
                        </div>
                        <div class="bp-leader">
        ...
        <section class="mb-16 bp-rise bp-rise-delay-2"
            ...
            <form @submit.prevent="submit" class="flex flex-col sm:flex-row items-stretch bg-paper border-x border-b border-ink" role="search">
                ...
                <div class="flex-1 flex items-center gap-4 px-5 sm:px-7 py-5 min-w-0">
                    ...
                    <input type="text"
                           ...
                           aria-label="{{ __('search.console_popular_aria') }}"
                           autocomplete="off"
                           autocapitalize="characters"
                           inputmode="text"
                           class="flex-1 bg-transparent font-mono uppercase tracking-wider
                                  text-xl sm:text-2xl font-medium text-ink
                ...
                <button type="submit"
                        class="group shrink-0 inline-flex items-center justify-center gap-3 px-6 sm:px-10 py-5
