        ...
        <section class="mb-10 bp-rise bp-rise-delay-3">
            ...
            @else
                ...
                <div class="border border-ink bg-paper overflow-hidden">
                    {{-- Table header --}}
                    <div class="hidden md:grid grid-cols-[5rem_1fr_1fr_8rem_6rem_7rem] items-center gap-4 px-5 py-3 bg-ink text-ivory">
                    ...
                    <ul class="divide-y divide-rule">
                        @foreach($products as $product)
                            <li class="group grid grid-cols-1 md:grid-cols-[5rem_1fr_1fr_8rem_6rem_7rem] items-center gap-2 md:gap-4 px-5 py-4 hover:bg-ivory-alt transition-colors">
                                {{-- # index --}}
