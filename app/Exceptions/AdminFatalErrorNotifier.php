 ...
 * handler while inside the admin panel — WordPress 5.2+'s fatal-error
 * protection does the same for a broken plugin/theme (mails the site admin
 * the exact error instead of leaving a silent white screen). Wired from
