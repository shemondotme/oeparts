...
class WidgetPreferenceService
{
    ...
    public const WIDGETS = [
        ...
        'awaiting_confirmation' => [
            ...
            'description' => 'Orders waiting for customer confirmation or payment',
            'group' => 'needs-attention',
            'default_visible' => true,
            'default_sort' => 8,
            'roles' => self::OPS,
        ...
        'manufacturing_stats' => [
            ...
            'description' => 'Statistics on active parts by manufacturer',
            'group' => 'catalog-search',
            'default_visible' => false,
            'default_sort' => 20,
            'roles' => self::CATALOG,
        ...
        'supplier_scorecard' => [
            ...
            'description' => 'Performance ratings for your suppliers',
            'group' => 'catalog-search',
            'default_visible' => false,
            'default_sort' => 21,
            'roles' => self::CATALOG,
        ...
        'queue_worker_status' => [
            ...
            'description' => 'Background job queue worker health',
            'group' => 'system-health',
            'default_visible' => false,
            'default_sort' => 25,
            'roles' => self::SYSTEM,
