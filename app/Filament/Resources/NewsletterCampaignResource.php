...
use App\Filament\Resources\NewsletterCampaignResource\RelationManagers\RecipientsRelationManager;
...
class NewsletterCampaignResource extends Resource
{
            ...
            ->actions([
                ...AdminUi::recordActions([
                    Tables\Actions\Action::make('send')
                        ...
                        ->modalDescription(fn (NewsletterCampaign $record): string => "This will send \"{$record->subject}\" to ".NewsletterSubscriber::where('is_active', true)->count().' active subscribers.'
                        )
    ...
    {
        return NavBadge::count('campaigns_draft', fn () => static::getModel()::where('status', 'draft')->count());
    }

    public static function getNavigationBadgeColor(): ?string
    {
        return (int) NavBadge::count('campaigns_draft', fn () => static::getModel()::where('status', 'draft')->count()) > 5 ? 'danger' : 'warning';
    }
