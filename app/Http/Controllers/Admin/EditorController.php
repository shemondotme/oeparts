...
{
    public function uploadImage(Request $request, UploadedImageSanitizer $sanitizer, ImageOptimizationService $optimizer): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'location' => Storage::url($optimized['path']),
        ]);
    }
