...
class HomeController extends Controller
{
    public function index(Request $request, string $lang)
    {
        ...
        // PageResource), so this is a simple override, not a merge. Cached:
        // ran unconditionally at the very top of the hottest single page in
        // the app, before the (already cached) section-based path below is
        // even reached.
        $homepage = app(CacheService::class)->rememberHomepagePageOverride(
            fn () => ['page' => Page::with('featuredImage')
