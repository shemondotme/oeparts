...
requests, discussions, and any other official OeParts channels), and also
...
reported to the maintainers at **shemonbd247@gmail.com**. All complaints
will be reviewed and investigated promptly and fairly, and the privacy and
security of the reporter will be respected.

> For **security vulnerabilities** (not conduct issues), do not email or
> open a public issue — see [SECURITY.md](SECURITY.md) instead.
